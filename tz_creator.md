...
**Совет:** Сразу утвердите ТЗ с заказчиком/тимлидом — это снизит число переделок.
...
- Индексы (по полям, участвующим в WHERE, JOIN, ORDER BY).
- Типы данных и дефолтные значения.
- Стратегия пагинации (offset/limit или курсоры).
